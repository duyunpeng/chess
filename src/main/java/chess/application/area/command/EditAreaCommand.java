package chess.application.area.command;

import org.hibernate.validator.constraints.NotBlank;
import chess.application.shared.command.SharedCommand;
import chess.core.enums.AreaLevel;
 ...
 */
public class EditAreaCommand extends SharedCommand {
    ...
    @NotBlank(message = "{area.sort.NotNull.messages}")
