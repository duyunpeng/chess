[@override name="title"]游戏倍数管理 - 游戏倍数创建[/@override]
...
<div class="row">
    <div class="col-lg-8">
        <form class="form-horizontal" action="/game_multiple/create" method="post" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="multiple" name="multiple"
                           value="${command.multiple!}" placeholder="输入游戏倍数"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="minMoney" name="minMoney"
                           value="${command.minMoney!}" placeholder="最小进入金额"
